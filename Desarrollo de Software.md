# 🏛️ Obsidian de Desarrollo de Software

> [!abstract] Bienvenido a tu Bóveda de Ingeniería
> Este es el núcleo de tu entorno de desarrollo de conocimiento. Desde aquí puedes acceder a los componentes principales de tu semestre, lecturas, apuntes y a tu entorno calibrado de IA.
> _Cuando domines el flujo, puedes editar o borrar este panel de bienvenida._
...
> [!danger] 🎯 Control de Evaluaciones y Parciales
> - 📝 **[[05_Evaluaciones/Parcial_1|Primer Parcial (20%)]]** -> *Patrones de Diseño (Creacionales/Estructurales/Comportamiento) y SOLID.* `[Completado]`
> - 📝 **[[Preparacion|Segundo Parcial (30%)]]** -> *Arquitectura (Hexagonal/Clean), DDD y Testing.* `[Completado]`
> - 🚀 **[[05_Evaluaciones/Proyecto_Final|Proyecto Final (10%)]]** -> *Entrega: Viernes 03 de Julio.* `[En Desarrollo]`
> - 🛑 **[[05_Evaluaciones/Parcial_3|Tercer Parcial (30%)]]** -> *Fecha: Jueves 09 de Julio.* `[Pendiente]`
