# 📚 Índice de Lecturas: Diseño y Arquitectura de Sistemas

> [!abstract] Control de Biblioteca Digital
> Todos los enlaces de esta página apuntan a los archivos PDF locales que residen en esta misma carpeta. Puedes usar el parámetro `#page=X` al final de cualquier enlace para abrir el documento directamente en la página deseada.
...
## 📅 Asignación de Lecturas por Unidades Técnicas
...
### 🧩 Unidad 3: Domain-Driven Design (Semanas 8 y 9)
- **Diseño Estratégico y Patrones Tácticos:**
	- ![[Principles_Practices_and_Practices_of_DDD_Millett.pdf]] — Capítulos 15 al 21 (Modelado rico del dominio: *Agregados, Entidades, Value Objects, Repositorios*).
	- ![[Hands_On_Domain_Driven_Design_Michael_Plod.pdf]] — Ejemplos guiados de modelado práctico del espacio de la solución.
	- ![[Clean_Architecture_with_NET_Dino_Esposito.pdf]] — Capítulos 1 al 3 (Mapeo de la lógica de negocio en la capa de aplicación).

### 🧪 Unidad 4: Estrategias de Testing Avanzado (Semanas 9, 10 y 12)
- **Mantenibilidad de Pruebas y TDD:**
	- ![[Unit_Testing_Principles_Practices_Patterns_Khorikov.pdf]] — Capítulos 2, 3, 4 y 5 (Los 4 pilares del buen unit testing, evitar pruebas frágiles y patrones de *Test Doubles*).
	- ![[Adaptive_Code_Gary_McLean_Hall.pdf]] — Capítulo 5 (TDD y ciclos de diseño guiados por pruebas).
	- ![[Growing_Object_Oriented_Software_Guided_by_Tests_Freeman.pdf]] — Capítulo 22 y apéndices.
	- ![[Effective_Software_Testing_Mauricio_Aniche.pdf]] — Capítulos 4, 7 y 10 (Estrategias empíricas de diseño de pruebas).
	- ![[Clean_Architecture_Robert_Martin.pdf]] — Capítulo 28 (Los tests como componentes del sistema).
- **Testing en Capas de Infraestructura (Semana 12):**
	- ![[Clean_Architecture_with_NET_Dino_Esposito.pdf]] — Capítulos 5 y 8 (Aislamiento de servicios externos).
	- ![[Principles_Practices_and_Practices_of_DDD_Millett.pdf]] — Capítulo 25 (Pruebas sobre los patrones tácticos).

### ⚡ Unidad 5: AOP, Refactoring y Patrones Avanzados (Semanas 13 y 14)
- **Programación Orientada a Aspectos (AOP):**
	- ![[Dependency_Injection_Principles_Practices_Patterns_Seemann.pdf]] — Capítulo 10 (Manejo de *Cross-cutting concerns* mediante Decoradores e Interceptores aplicando SOLID).
- **Técnicas de Refactorización:**
	- ![[Refactoring_Improving_Design_Existing_Code_Fowler.pdf]] — Catálogo completo de transformaciones de código preservando comportamiento externo.
	- ![[Adaptive_Code_Gary_McLean_Hall.pdf]] — Capítulo 6 (Mitigación de deuda técnica en sistemas legados).